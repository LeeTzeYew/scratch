...
const downloadMicrobitHex = async () => {
    ...
    const url = 'http://localhost:8082/scratch-microbit-1.2.0.hex.zip';
    // const url = path.join(__dirname, 'lib', 'scratch-microbit.hex.zip');
    ...
    try {
        ...
        console.warn('Warning: Failed to download microbit firmware, continuing anyway...');
    }
};
